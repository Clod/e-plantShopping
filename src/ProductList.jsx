...
import { addItem, removeItem, clearCart, getCartTotal } from './CartSlice';
...
function ProductList() {
    ...
    /*
        Parameter product is an object with the following keys:
        {
            name: "Echinacea",
            image: "https://cdn.pixabay.com/photo/2014/12/05/03/53/echinacea-557477_1280.jpg",
            description: "Boosts immune system, helps fight colds.",
            ...
            {!showCart ? (
                <div className="product-grid">
                    {plantsArray.map((category, index) => (
                        <div key={index}>
                            <h1 style={{ textAlign: 'center', borderTop: '2px solid #ccc', borderBottom: '2px solid #ccc', padding: '10px 0' }}><div>{category.category}</div></h1>
